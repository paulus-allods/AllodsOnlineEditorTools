...
/// token(s) — the enum member name, or the raw number when the value is absent from the (possibly
/// incomplete) recovered enum — and back. Formats serialize the tokens with their ordinary string/number
