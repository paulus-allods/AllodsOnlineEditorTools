...
internal class ResourcePointerBinaryConverter : BinaryConverter<ResourcePointer>
{
    ...
    protected override ResourcePointer ReadValue(ref BinaryStructReader reader, int offset, Type typeToConvert, BinaryStructSerializerContext context)
    {
    ...
    protected override void WriteValue(BinaryStructWriter writer, int offset, ResourcePointer value, BinaryStructSerializerContext context)
    {
