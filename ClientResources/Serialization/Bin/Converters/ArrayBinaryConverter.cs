...
internal class ArrayBinaryConverter : BinaryConverter<Array>
{
    ...
    protected override Array ReadValue(ref BinaryStructReader reader, int offset, Type typeToConvert, BinaryStructSerializerContext context)
    {
    ...
    protected override void WriteValue(BinaryStructWriter writer, int offset, Array? value, BinaryStructSerializerContext context)
    {
