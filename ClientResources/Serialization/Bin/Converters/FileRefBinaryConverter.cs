...
internal class FileRefBinaryConverter : BinaryConverter<FileRef>
{
    ...
    protected override FileRef ReadValue(ref BinaryStructReader reader, int offset, Type typeToConvert, BinaryStructSerializerContext context)
    {
    ...
    protected override void WriteValue(BinaryStructWriter writer, int offset, FileRef value, BinaryStructSerializerContext context)
    {
