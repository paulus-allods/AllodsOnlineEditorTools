...
internal class Vector2BinaryConverter : BinaryConverter<Vector2>
{
    ...
    protected override Vector2 ReadValue(ref BinaryStructReader reader, int offset, Type typeToConvert,
    ...
    protected override void WriteValue(BinaryStructWriter writer, int offset, Vector2 value,
        BinaryStructSerializerContext context)
    {
