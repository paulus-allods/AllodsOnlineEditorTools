...
internal class Vector2BinaryConverter : BinaryConverter<Vector2>
{
    ...
    protected override Vector2 ReadValue(ref BinaryStructReader reader, long offset, Type typeToConvert, BinaryStructSerializerContext context)
    {
    ...
    protected override void WriteValue(BinaryStructWriter writer, long offset, Vector2 value, BinaryStructSerializerContext context)
    {
