...
{
    protected abstract T ReadValue(ref BinaryStructReader reader, int offset, Type typeToConvert, BinaryStructSerializerContext context);
    protected abstract void WriteValue(BinaryStructWriter writer, int offset, T? value, BinaryStructSerializerContext context);
    ...
    public object? Read(ref BinaryStructReader reader, int offset, Type typeToConvert, BinaryStructSerializerContext context)
    {
