...
public class GameVersion
{
    ...
    public static bool TryGetByVersion(byte[] version, [NotNullWhen(true)] out GameVersion? gameVersion) =>
        Versions.TryGetValue(Convert.ToHexString(version), out gameVersion);
    ...
    [
        ...
        new() { Name = "Allods Online 1.1.04.44", Hash = "304C70AC5A6F33D0", FileRefKind = FileRefKind.FileRef, },
        new()
        {
        ...
        new() { Name = "Cloud Pirates 1.7.7", Hash = "B077EC9F77A40AA0", FileRefKind = FileRefKind.None, },
        new() { Name = "Allods Online 14.0.00.21", Hash = "44068E78E8E67876", FileRefKind = FileRefKind.PakFileRef, },
        new()
        {
    ...
    public static readonly IReadOnlyList<string> StructNamespaces = Versions.Values.Where(version => version.HasStructs).Select(version => version.Namespace)
