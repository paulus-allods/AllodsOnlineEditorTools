...
public partial class WidgetButton
{
    ...
    [FieldOffset(268)][XdbName("TextStyle")] public TextStyle textStyle;
    ...
    {
        [FieldOffset(4)][XdbName("LayerHighlight")] public ResourcePointer layerHighlight;
        [FieldOffset(12)][XdbName("PushedOffset")] public Vector2 pushedOffset;
        [FieldOffset(20)][XdbName("Reaction")] public string reaction;
        [FieldOffset(32)][XdbName("ReactionRightClick")] public string reactionRightClick;
        [FieldOffset(44)][XdbName("StateDisabled")] public StateDisabled stateDisabled;
        [FieldOffset(72)][XdbName("StateHighlighted")] public StateDisabled stateHighlighted;
        [FieldOffset(100)][XdbName("StateNormal")] public StateDisabled stateNormal;
        [FieldOffset(128)][XdbName("StatePushed")] public StateDisabled statePushed;
        [FieldOffset(156)][XdbName("StatePushedHighlighted")] public StateDisabled statePushedHighlighted;
        [FieldOffset(184)][XdbName("TextFileRef")] public TextFileRef textFileRef;
        ...
        [FieldOffset(228)][XdbName("ReactionOnUp")] public bool reactionOnUp;

        [StructSize(28)]
        [UsedImplicitly(ImplicitUseTargetFlags.WithMembers)]
        public class StateDisabled
        {
            [FieldOffset(4)][XdbName("FormatFileRef")] public TextFileRef formatFileRef;
            [FieldOffset(20)][XdbName("LayerMain")] public ResourcePointer layerMain;
        }
    }
}
